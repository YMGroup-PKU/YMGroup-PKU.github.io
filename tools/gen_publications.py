...
Conventions:
  ...
  - Categories map to _config.yml `publication_category`:
      corresponding -> Selected & Corresponding/First-Author Papers
      coauthored    -> Co-authored Papers
      before        -> Publications Before Peking University
"""
import os
import re
...
PAPERS = [
    ...
    # ===== before joining PKU =====
    ("ml-cfd-lpt-wakemixing", 2021, "before",
    ...
    ("hpt-vane-large-disturbances", 2021, "before",
    ...
    ("bypass-transition-pg-curvature", 2020, "before",
     "<b>Y. Zhao</b>*, R. D. Sandberg",
    ...
    ("rans-model-cfd-driven-ml", 2020, "before",
    ...
    ("entropy-loss-rans-hpt", 2020, "before",
     "<b>Y. Zhao</b>*, R. D. Sandberg",
    ...
    ("scalar-flux-jet-crossflow", 2020, "before",
    ...
    ("sinuous-vortex-spots", 2018, "before",
    ...
    ("constrained-les-transition", 2014, "before",
